                ...
                if (bulletCounter >= (100 / player.fireRate))
                {
                    ...
                    if (bulletguntype == 0 || bulletguntype == 3)
                    {
                        for (int i = 0; i < bullet.bulletLevel; i++)
                        {
                            ...
                            {
                                bullet.createBullet(playercords[0] - 35, playercords[1] + 17, 0, bulletcounter);
                            }
                            else if (bullet.bulletLevel == 2)
                            {
                                if (i == 0)
                                {
                                    bullet.createBullet(playercords[0] - 35, playercords[1] + 7, 0, bulletcounter);
                                }
                                else
                                {
                                    bullet.createBullet(playercords[0] - 35, playercords[1] + 27, 0, bulletcounter);
                                }
                            }
                            else if (bullet.bulletLevel == 3)
                            {
                                bullet.createBullet(playercords[0] - 35, playercords[1] + (-3 + (i * 20)), 0, bulletcounter);
                            }
                            else if (bullet.bulletLevel == 4)
                            {
                                if (i == 3)
                                {
                                    bullet.createBullet(playercords[0] - 30, playercords[1] - 43, 1, bulletcounter);

                                }
                                else
                                {
                                    bullet.createBullet(playercords[0] - 35, playercords[1] + (-13 + (i * 20)), 0, bulletcounter);
                                }
                            ...
                            else if (bullet.bulletLevel == 5)
                            {
                                ...
                                {
                                    bullet.createBullet(playercords[0] - 30, playercords[1] + 67, 2, bulletcounter);
                                }
                                else
                                {
                                    bullet.createBullet(playercords[0] - 35, playercords[1] + (-3 + (i * 20)), 0, bulletcounter);
                            ...
                            else if (bullet.bulletLevel == 6)
                            {
                                ...
                                {
                                    bullet.createBullet(playercords[0] + 5, playercords[1] - 43, 1, bulletcounter);
                                }
                                else
                                {
                                    bullet.createBullet(playercords[0] - 35, playercords[1] + (-3 + (i * 20)), 0, bulletcounter);
                            ...
                            else if (bullet.bulletLevel == 7)
                            {
                                ...
                                {
                                    bullet.createBullet(playercords[0] + 5, playercords[1] + 67, 2, bulletcounter);
                                }
                                else
                                {
                                    bullet.createBullet(playercords[0] - 35, playercords[1] + (-3 + (i * 20)), 0, bulletcounter);
                            ...
                            else if (bullet.bulletLevel == 8)
                            {
                                ...
                                {
                                    bullet.createBullet(playercords[0] + 40, playercords[1] - 43, 1, bulletcounter);
                                }
                                else
                                {
                                    bullet.createBullet(playercords[0] - 35, playercords[1] + (-3 + (i * 20)), 0, bulletcounter);
                            ...
                            else if (bullet.bulletLevel == 9)
                            {
                                ...
                                {
                                    bullet.createBullet(playercords[0] + 40, playercords[1] + 67, 2, bulletcounter);
                                }
                                else
                                {
                                    bullet.createBullet(playercords[0] - 35, playercords[1] + (-3 + (i * 20)), 0, bulletcounter);
                    ...
                    {
                        int xcord = player.cords[0] - 30;
                        int ycord = player.cords[1] - 8;
                        for (int i = 0; i < bullet.bulletLevel; i++)
                        {
                            bulletcounter += 1;
                    ...
                    else if (bulletguntype == 2)  //create pulse type bullet
                    {
                        ...
                        for (int i = 0; i < bullet.bulletLevel; i++)
                        {
                            ...
                            if (i == 0) 
                            {
                                ...
                                ycord = player.cords[1] - 8;
                                bullet.createPulse(xcord, ycord, bulletcounter, 1);
                            }
                            else if (i == 1)
                            {
                                xcord = player.cords[0] + 10;
                                ycord = player.cords[1] - 40;
                                bullet.createPulse(xcord, ycord, bulletcounter, 2);
                            }
                            else if (i == 2) 
                            {
                                xcord = player.cords[0] + 10;
                                ycord = player.cords[1] + 40;
                                bullet.createPulse(xcord, ycord, bulletcounter, 3);
                            }
                            else if (i == 3)
                            {
                    ...
                    else if (bulletguntype == 4)  //create canon ball type bullet
                    {
                        ...
                        for (int i = 0; i < bullet.bulletLevel; i++)
                        {
                            ...
                            if (i == 0)
                            {
                                ...
                                bullet.createCanonBall(xcord, ycord, bulletcounter, 0);
                            }
                            else if (i == 1)
                            {
                                xcord = player.cords[0] + 54;
                                ycord = player.cords[1] - 34;
                                bullet.createCanonBall(xcord, ycord, bulletcounter, 1);
                            }
                            else if (i == 2)
                            {
                                xcord = player.cords[0] + 54;
                                ycord = player.cords[1] + 54;
                                bullet.createCanonBall(xcord, ycord, bulletcounter, 2);
                            }
                            else if (i == 3)
                            {
                                xcord = player.cords[0] - 30;
                    ...
                    else if (bulletguntype == 5)  //create missile type bullet
                    {
                        ...
                        for (int i = 0; i < bullet.bulletLevel; i++)
                        {
                            ...
                            if (i == 0)
                            {
                                xcord = player.cords[0] - 30;
                                ycord = player.cords[1] + 10;
                                bullet.createMissile(xcord, ycord, bulletcounter, 10);
                            }
                            else if (i == 1)
                            {
                                xcord = player.cords[0] + 54;
                                ycord = player.cords[1] - 34;
                                bullet.createMissile(xcord, ycord, bulletcounter, 21);
                            }
                            else if (i == 2)
                            {
                                xcord = player.cords[0] + 54;
                                ycord = player.cords[1] + 54;
                                bullet.createMissile(xcord, ycord, bulletcounter, 32);
                            }
                            else if (i == 3)
                            {
                                xcord = player.cords[0] - 30;
                                ycord = player.cords[1] + 40;
                                bullet.createMissile(xcord, ycord, bulletcounter, 40);
                            }
                            else if (i == 4)
                            {
                                xcord = player.cords[0] + 94;
                                ycord = player.cords[1] - 34;
                                bullet.createMissile(xcord, ycord, bulletcounter, 51);
                            }
                            else if (i == 5)
                            {
                                xcord = player.cords[0] + 94;
                                ycord = player.cords[1] + 54;
                                bullet.createMissile(xcord, ycord, bulletcounter, 62);
                            }
                            else if (i == 6)
                            {
                                xcord = player.cords[0] - 30;
                                ycord = player.cords[1] - 20;
                                bullet.createMissile(xcord, ycord, bulletcounter, 70);
                            }
                            else if (i == 7)
                            {
                                xcord = player.cords[0] + 14;
                                ycord = player.cords[1] - 34;
                                bullet.createMissile(xcord, ycord, bulletcounter, 81);
                            }
                            else if (i == 8)
                            {
                                xcord = player.cords[0] + 14;
                                ycord = player.cords[1] + 54;
                                bullet.createMissile(xcord, ycord, bulletcounter, 92);
                            }
                        }
                    ...
                    else if (bulletguntype == 6)  //create guided missile type bullet
                    {
                        ...
                        for (int i = 0; i < bullet.bulletLevel; i++)
                        {
                            ...
                            if (i == 0)
                            {
                                xcord = player.cords[0] - 30;
                                ycord = player.cords[1] + 10;
                                bullet.createGuidedMissile(xcord, ycord, bulletcounter, 0);
                            }
                            else if (i == 1)
                            {
                                xcord = player.cords[0] + 54;
                                ycord = player.cords[1] - 34;
                                bullet.createGuidedMissile(xcord, ycord, bulletcounter, 1);
                            }
                            else if (i == 2)
                            {
                                xcord = player.cords[0] + 54;
                                ycord = player.cords[1] + 54;
                                bullet.createGuidedMissile(xcord, ycord, bulletcounter, 2);
                            }
                            else if (i == 3)
                            {
                                xcord = player.cords[0] - 30;
            ...
            foreach (int dropkey in drop.dropcords.Keys)
            {
                if (colideRects(drop.dropcords[dropkey], imgS.dropimgs.ElementAt(drop.droptypes[dropkey]).Value, player.cords, player.size))  // collusion Detection between drops and player 
                {
                    ...
                    else if (droptype == 9) // canon gun
                    {
                        ...
                        player.inverntory[droptype - 10] += 1;
                    }
                }
            }
            if (keysRemove.Count != 0)
